...
The rbf kernel is typically defined as $k(x,z) = exp\frac{-d(x,z)^2}{2*\sigma^2}$, which can be re-defined in terms of gamma as $k(x,z) = exp(-\gamma*(d(x,z)^2))$, where $\gamma = 1/(2*\sigma^2)$.
